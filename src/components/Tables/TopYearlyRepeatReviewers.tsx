...
const TopYearlyRepeatReviewers = () => {
    return (
        <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
            <div className="max-w-full overflow-x-auto">
                <h4 className="mb-6 text-xl font-semibold text-black dark:text-white">
                    Top Yearly Repeat Reviewers
                </h4>
                            ...
                            <tr key={key}>
                                <td className="flex items-center gap-3 border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                                    <div className="flex-shrink-0">
                                        <Image src={packageItem.logo} alt="Brand" width={48} height={48} />
                                    </div>
...
export default TopYearlyRepeatReviewers;
